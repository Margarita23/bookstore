...
book_05 = Book.create(title: "The Master and Margarita", price: 25.00, quantity: 31, description: description, category_id: category_sc_fic.id, bought: 0, author_id: author_05.id)
